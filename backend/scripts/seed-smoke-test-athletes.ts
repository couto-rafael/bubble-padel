...
const SEED_DEFS = [
  ...
  // Sprint 8.5 — 35 additional for Regular tournament smoke test
  { email: "seed.h@bubble.test",  firstName: "Atleta H",  lastName: "Seed" },
  { email: "seed.i@bubble.test",  firstName: "Atleta I",  lastName: "Seed" },
  { email: "seed.j@bubble.test",  firstName: "Atleta J",  lastName: "Seed" },
  { email: "seed.k@bubble.test",  firstName: "Atleta K",  lastName: "Seed" },
  { email: "seed.l@bubble.test",  firstName: "Atleta L",  lastName: "Seed" },
  { email: "seed.m@bubble.test",  firstName: "Atleta M",  lastName: "Seed" },
  { email: "seed.n@bubble.test",  firstName: "Atleta N",  lastName: "Seed" },
  { email: "seed.o@bubble.test",  firstName: "Atleta O",  lastName: "Seed" },
  { email: "seed.p@bubble.test",  firstName: "Atleta P",  lastName: "Seed" },
  { email: "seed.q@bubble.test",  firstName: "Atleta Q",  lastName: "Seed" },
  { email: "seed.r@bubble.test",  firstName: "Atleta R",  lastName: "Seed" },
  { email: "seed.s@bubble.test",  firstName: "Atleta S",  lastName: "Seed" },
  { email: "seed.t@bubble.test",  firstName: "Atleta T",  lastName: "Seed" },
  { email: "seed.u@bubble.test",  firstName: "Atleta U",  lastName: "Seed" },
  { email: "seed.v@bubble.test",  firstName: "Atleta V",  lastName: "Seed" },
  { email: "seed.w@bubble.test",  firstName: "Atleta W",  lastName: "Seed" },
  { email: "seed.x@bubble.test",  firstName: "Atleta X",  lastName: "Seed" },
  { email: "seed.y@bubble.test",  firstName: "Atleta Y",  lastName: "Seed" },
  { email: "seed.z@bubble.test",  firstName: "Atleta Z",  lastName: "Seed" },
  { email: "seed.aa@bubble.test", firstName: "Atleta AA", lastName: "Seed" },
  { email: "seed.ab@bubble.test", firstName: "Atleta AB", lastName: "Seed" },
  { email: "seed.ac@bubble.test", firstName: "Atleta AC", lastName: "Seed" },
  { email: "seed.ad@bubble.test", firstName: "Atleta AD", lastName: "Seed" },
  { email: "seed.ae@bubble.test", firstName: "Atleta AE", lastName: "Seed" },
  { email: "seed.af@bubble.test", firstName: "Atleta AF", lastName: "Seed" },
  { email: "seed.ag@bubble.test", firstName: "Atleta AG", lastName: "Seed" },
  { email: "seed.ah@bubble.test", firstName: "Atleta AH", lastName: "Seed" },
  { email: "seed.ai@bubble.test", firstName: "Atleta AI", lastName: "Seed" },
  { email: "seed.aj@bubble.test", firstName: "Atleta AJ", lastName: "Seed" },
  { email: "seed.ak@bubble.test", firstName: "Atleta AK", lastName: "Seed" },
  { email: "seed.al@bubble.test", firstName: "Atleta AL", lastName: "Seed" },
  { email: "seed.am@bubble.test", firstName: "Atleta AM", lastName: "Seed" },
  { email: "seed.an@bubble.test", firstName: "Atleta AN", lastName: "Seed" },
  { email: "seed.ao@bubble.test", firstName: "Atleta AO", lastName: "Seed" },
  { email: "seed.ap@bubble.test", firstName: "Atleta AP", lastName: "Seed" },
];
