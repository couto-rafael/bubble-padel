...
/**
 * Footer compartilhado — usado em Home, Tournaments e TournamentProfile.
 * Mobile: logo + links compactos em linha.
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="md:hidden">
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="font-bold text-sm">Bubble Padel</span>
          </div>
          ...
          <div className="flex items-center justify-between border-t border-white/5 pt-3">
            <p className="text-xs text-gray-500">© 2026 Bubble Padel</p>
            <div className="flex gap-4">
              ...
              />
              <SocialIcon
                href="https://github.com/couto-rafael/bubble-padel"
        ...
        {/* Desktop bottom bar */}
        <div className="hidden md:flex border-t border-white/5 pt-8 flex-col md:flex-row justify-between items-center gap-4">
...
const SocialIcon = ({ href, path }: { href: string; path: string }) => (
  <a href={href} className="text-gray-500 hover:text-white transition-colors">
