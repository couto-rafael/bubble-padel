        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link to="/contact" className="text-white font-medium text-sm">
                Contato
              </Link>
              <button
      ...
      <section className="relative pt-32 pb-16 px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Tem alguma dúvida ou precisa de ajuda? Nossa equipe está pronta para
            ajudar você a organizar torneios incríveis.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-gradient-to-br from-[#1a1f4a]/50 to-[#0f1540]/50 p-6 rounded-xl border border-white/10">
                ...
                <a
                  href="mailto:contato@bubble.com.br"
              ...
              <div className="bg-gradient-to-br from-[#1a1f4a]/50 to-[#0f1540]/50 p-6 rounded-xl border border-white/10">
                ...
                <div className="flex gap-4">
                  <a
                    href="#"
                    className="w-10 h-10 bg-white/5 hover:bg-[#00ff88]/20 rounded-lg flex items-center justify-center transition-all hover:scale-110"
                  >
                    <svg
                      className="w-5 h-5 text-gray-400 hover:text-[#00ff88]"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
            ...
            <div className="lg:col-span-2">
              <div className="bg-gradient-to-br from-[#1a1f4a]/50 to-[#0f1540]/50 p-8 rounded-xl border border-white/10">
                ...
                {formSubmitted ? (
                  <div className="bg-[#00ff88]/20 border border-[#00ff88]/30 rounded-lg p-6 text-center">
                    ...
                    <h3 className="text-xl font-bold mb-2 text-[#00ff88]">
                      Mensagem Enviada!
                    </h3>
              ...
              <div className="mt-8 bg-gradient-to-br from-[#1a1f4a]/50 to-[#0f1540]/50 p-6 rounded-xl border border-white/10">
                ...
                <div className="space-y-3">
                  <a
                    href="#"
                    className="block text-gray-400 hover:text-[#00ff88] transition-colors text-sm"
                  >
